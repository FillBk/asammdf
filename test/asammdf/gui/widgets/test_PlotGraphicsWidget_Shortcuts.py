...
class TestPlotGraphicsShortcuts(TestPlotWidget):
    ...
    def setUp(self):
        ...
        # PlotGraphics object
        self.pg = self.plot.plot

        # Setup for PlotGraphics
        if self.pg.with_dots:
            self.pg.set_dots(False)
        ...
        if self.pg.cursor1.show_circle:
            self.pg.cursor1.show_circle = False
    ...
    def test_key_S_ShiftS_ShiftF_F(self):
        """
        Test Scope:
            Check if:
    ...
    def test_key_Ctrl_S(self):
        ...
        # Ensure that all channels from the first plot are checked
